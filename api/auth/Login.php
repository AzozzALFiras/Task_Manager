...
$Login_User = $Task_Manager->Login_User($User_Name,$User_Password,$link);
echo json_encode($Login_User, JSON_PRETTY_PRINT);

} else {
$array_json = [
'Status_Text' => "Password missing You can't login without a password",
'Status_Login'=> "ERROR"
];
...
$array_json = [
'Status_Text' => "Username missing You can't login without a username",
'Status_Login'=> "ERROR"
];
echo json_encode($array_json, JSON_PRETTY_PRINT);
}
